# #FirstMover Directory

Companies and creators who are first to apply AI to solve a real problem in their industry.

Want to be listed? [Submit a Pull Request](https://github.com/dstolts/FirstMover/pulls) with your entry following the format below.

Want to get certified? See [CERTIFIED.md](CERTIFIED.md) for details.

---

## Directory

| # | Name | URL | Scope | Industry | Gap Filled | Tier |
|---|------|-----|-------|----------|------------|------|
...
To submit your entry, add a row to the table above with:
...
| URL | Your website |
| Scope | Global, Industry, or Regional (with location) |
| Industry | Your industry vertical |
| Gap Filled | What problem you solved, why it qualifies as first mover. If competitors exist, name them and explain why you were first |
| Tier | Open or Certified |
